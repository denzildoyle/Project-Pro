...
export const Registration = (): JSX.Element => {
	...
	const validateForm = (): boolean => {
		...
		if (!formData.playerDateOfBirth) {
			...
			if (age < 5 || age > 25) {
				newErrors.playerDateOfBirth = "Player must be between 5 and 25 years old";
			}
		}
				...
				<form onSubmit={handleSubmit} className="space-y-8">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription className="font-['Manrope',Helvetica] text-[#607589]">
								Please provide your details as the parent/guardian
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-4">
							<div className="space-y-2">
								<Label htmlFor="parentName" className="font-['Manrope',Helvetica] font-medium text-[#111416]">
									Parent Name *
								</Label>
								<Input
									id="parentName"
									...
									className={`font-['Manrope',Helvetica] ${errors.parentName ? "border-red-500" : ""}`}
								/>
								{errors.parentName && (
							...
							<div className="space-y-2">
								<Label htmlFor="parentEmail" className="font-['Manrope',Helvetica] font-medium text-[#111416]">
									Parent Email *
								</Label>
								<Input
									id="parentEmail"
									...
									className={`font-['Manrope',Helvetica] ${errors.parentEmail ? "border-red-500" : ""}`}
								/>
								{errors.parentEmail && (
									<p className="text-sm text-red-500 font-['Manrope',Helvetica]">
										{errors.parentEmail}
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<div className="space-y-2">
									<Label htmlFor="parentPassword" className="font-['Manrope',Helvetica] font-medium text-[#111416]">
										Password *
									</Label>
									<Input
										id="parentPassword"
										...
										className={`font-['Manrope',Helvetica] ${errors.parentPassword ? "border-red-500" : ""}`}
									/>
								...
								<div className="space-y-2">
									<Label htmlFor="confirmPassword" className="font-['Manrope',Helvetica] font-medium text-[#111416]">
										Confirm Password *
									</Label>
									<Input
										id="confirmPassword"
										...
										className={`font-['Manrope',Helvetica] ${errors.confirmPassword ? "border-red-500" : ""}`}
									/>
					...
					<Card>
						...
						<CardContent className="space-y-4">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<div className="space-y-2">
									<Label htmlFor="playerName" className="font-['Manrope',Helvetica] font-medium text-[#111416]">
										Player Name *
									</Label>
									<Input
										id="playerName"
										...
										className={`font-['Manrope',Helvetica] ${errors.playerName ? "border-red-500" : ""}`}
									/>
									{errors.playerName && (
										<p className="text-sm text-red-500 font-['Manrope',Helvetica]">
											{errors.playerName}
								...
								<div className="space-y-2">
									<Label htmlFor="playerDateOfBirth" className="font-['Manrope',Helvetica] font-medium text-[#111416]">
										Date of Birth *
									</Label>
									<Input
										...
										className={`font-['Manrope',Helvetica] ${errors.playerDateOfBirth ? "border-red-500" : ""}`}
									/>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<div className="space-y-2">
									<Label htmlFor="playerStrongFoot" className="font-['Manrope',Helvetica] font-medium text-[#111416]">
										Strong Foot *
									</Label>
									<Select
										value={formData.playerStrongFoot}
										onValueChange={(value) => handleInputChange("playerStrongFoot", value)}
									>
										<SelectTrigger className={`font-['Manrope',Helvetica] ${errors.playerStrongFoot ? "border-red-500" : ""}`}>
											<SelectValue placeholder="Select strong foot" />
										</SelectTrigger>
										<SelectContent>
											{strongFootOptions.map((foot) => (
												<SelectItem key={foot} value={foot} className="font-['Manrope',Helvetica]">
													{foot}
												</SelectItem>
											))}
										</SelectContent>
								...
								<div className="space-y-2">
									<Label htmlFor="playerCountry" className="font-['Manrope',Helvetica] font-medium text-[#111416]">
										Country *
									</Label>
									<Select
										value={formData.playerCountry}
										onValueChange={(value) => handleInputChange("playerCountry", value)}
									>
										<SelectTrigger className={`font-['Manrope',Helvetica] ${errors.playerCountry ? "border-red-500" : ""}`}>
											<SelectValue placeholder="Select country" />
										</SelectTrigger>
										<SelectContent>
											{countries.map((country) => (
												<SelectItem key={country} value={country} className="font-['Manrope',Helvetica]">
													{country}
												</SelectItem>
											))}
										</SelectContent>
							...
							<div className="space-y-2">
								<Label htmlFor="playerPosition" className="font-['Manrope',Helvetica] font-medium text-[#111416]">
									Position (Optional)
								</Label>
								<Select
									value={formData.playerPosition}
									onValueChange={(value) => handleInputChange("playerPosition", value)}
								>
							...
							<div className="space-y-2">
								<Label htmlFor="playerPhoto" className="font-['Manrope',Helvetica] font-medium text-[#111416]">
								...
								<Input
									...
									onChange={(e) => handleInputChange("playerPhoto", e.target.value)}
