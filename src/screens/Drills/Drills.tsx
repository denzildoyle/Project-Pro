...
const drillsData: Drill[] = [
	{
		...
		type: "assessment",
		description: "Players dribble through a series of cones while maintaining ball control and speed. This drill assesses technical ability, agility, and ball control under pressure.",
		drillDesign: "Set up 8 cones in a straight line, 2 yards apart. Players start at one end and weave through all cones.",
		ageGroup: "U15",
		topic: "Ball Control & Dribbling",
		equipment: ["8 Cones", "1 Football per player", "Stopwatch", "Clipboard for scoring"],
	...
	},
	{
		...
		type: "assessment",
		description: "Players attempt to hit specific targets from various distances to assess passing accuracy and technique under different conditions.",
		drillDesign: "Set up 3 target zones at 10, 20, and 30 yards with different sized goals or markers.",
		ageGroup: "U17",
		topic: "Passing & Accuracy",
		equipment: ["6 Cones", "3 Small goals or targets", "10 Footballs", "Measuring tape"],
	...
	},
	{
		...
		type: "training",
		description: "A fun and competitive small-sided game focused on maintaining possession and quick passing. Great for developing teamwork and ball retention skills.",
		drillDesign: "Create a 30x20 yard area with two teams of 4 players each, plus 2 neutral players who always play with the team in possession.",
		ageGroup: "U15",
		topic: "Possession & Teamwork",
		equipment: ["8 Cones", "2 Sets of bibs", "2 Footballs", "Small goals (optional)"],
	...
	},
	{
		...
		type: "training",
		description: "Fundamental footwork training using agility ladders to improve coordination, speed, and agility. Essential for all field players.",
		drillDesign: "Use 2-3 agility ladders placed parallel to each other with different footwork patterns for each ladder.",
		ageGroup: "U13",
	...
	},
	{
		...
		type: "assessment",
		description: "Individual defensive assessment where players must defend against an attacker in a confined space. Tests defensive positioning, timing, and decision-making.",
		drillDesign: "Create a 15x10 yard channel with a small goal at one end. Defender starts in the middle, attacker at the opposite end.",
		ageGroup: "U17",
	...
	},
	{
		...
		type: "training",
		description: "Comprehensive shooting practice focusing on technique, power, and accuracy from various angles and distances.",
		drillDesign: "Set up multiple shooting stations around the penalty area with different angles and distances to goal.",
		ageGroup: "U15",
		topic: "Shooting & Finishing",
		equipment: ["1 Full-size goal", "20 Footballs", "6 Cones", "Goalkeeper equipment"],
...
export const Drills = (): JSX.Element => {
	...
	const [filterType, setFilterType] = useState<"all" | "assessment" | "training">("all");
	...
	const filteredDrills = drillsData.filter(drill => {
		...
		const matchesAgeGroup = filterAgeGroup === "all" || drill.ageGroup === filterAgeGroup;
		const matchesDifficulty = filterDifficulty === "all" || drill.difficulty === filterDifficulty;

		return matchesSearch && matchesType && matchesAgeGroup && matchesDifficulty;
	});
						...
						<div className="flex flex-wrap justify-between gap-3 p-4">
							<div className="flex min-w-72 flex-col gap-3">
								...
								<p className="text-[#60758a] text-sm font-normal leading-normal font-['Manrope',Helvetica]">
									Comprehensive collection of training and assessment drills for all age groups
								</p>
							</div>
							...
							<div className="bg-white rounded-lg shadow-sm border border-[#dbe0e5] p-6">
								<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
									...
									<Select value={filterType} onValueChange={(value: any) => setFilterType(value)}>
										...
										<SelectContent>
											<SelectItem value="all" className="font-['Manrope',Helvetica]">All Types</SelectItem>
											<SelectItem value="assessment" className="font-['Manrope',Helvetica]">Assessment</SelectItem>
											<SelectItem value="training" className="font-['Manrope',Helvetica]">Training</SelectItem>
										</SelectContent>
									</Select>
									...
									<Select value={filterAgeGroup} onValueChange={setFilterAgeGroup}>
										...
										<SelectContent>
											<SelectItem value="all" className="font-['Manrope',Helvetica]">All Ages</SelectItem>
											<SelectItem value="U13" className="font-['Manrope',Helvetica]">U13</SelectItem>
											<SelectItem value="U15" className="font-['Manrope',Helvetica]">U15</SelectItem>
											<SelectItem value="U17" className="font-['Manrope',Helvetica]">U17</SelectItem>
										</SelectContent>
									</Select>
									...
									<Select value={filterDifficulty} onValueChange={setFilterDifficulty}>
										...
										<SelectContent>
											<SelectItem value="all" className="font-['Manrope',Helvetica]">All Levels</SelectItem>
											<SelectItem value="Beginner" className="font-['Manrope',Helvetica]">Beginner</SelectItem>
											<SelectItem value="Intermediate" className="font-['Manrope',Helvetica]">Intermediate</SelectItem>
											<SelectItem value="Advanced" className="font-['Manrope',Helvetica]">Advanced</SelectItem>
										</SelectContent>
									</Select>
								</div>
							</div>
										...
										<CardHeader className="pb-3">
											<div className="flex justify-between items-start mb-2">
												...
												<div className="flex flex-col gap-1">
													<Badge 
														variant="secondary" 
														className={`text-xs ${getTypeColor(drill.type)}`}
													>
														{drill.type}
													</Badge>
													{drill.hasScoring && (
										...
										<CardContent className="pt-0">
											<div className="space-y-3">
												...
												<div className="flex justify-between items-center">
													<Badge variant="outline" className="text-xs font-['Manrope',Helvetica]">
						...
						<>
							<DialogHeader>
								...
								<DialogDescription className="font-['Manrope',Helvetica] text-[#607589]">
									{selectedDrill.type === 'assessment' ? 'Assessment Drill' : 'Training Drill'} • {selectedDrill.ageGroup} • {selectedDrill.difficulty}
								</DialogDescription>
							</DialogHeader>
							...
							<div className="space-y-6">
								...
								<div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
									<div className="text-sm">
										<div className="flex items-center gap-1 text-[#60758a] mb-1">
											...
											<span className="font-medium font-['Manrope',Helvetica]">Duration</span>
										</div>
										<span className="text-[#111418] font-['Manrope',Helvetica]">{selectedDrill.duration}</span>
									</div>
									<div className="text-sm">
										<div className="flex items-center gap-1 text-[#60758a] mb-1">
											<Users className="w-4 h-4" />
											<span className="font-medium font-['Manrope',Helvetica]">Players</span>
										</div>
										<span className="text-[#111418] font-['Manrope',Helvetica]">{selectedDrill.numberOfPlayers}</span>
									</div>
									<div className="text-sm">
										<div className="flex items-center gap-1 text-[#60758a] mb-1">
											<Ruler className="w-4 h-4" />
											<span className="font-medium font-['Manrope',Helvetica]">Space</span>
										</div>
										<span className="text-[#111418] font-['Manrope',Helvetica]">{selectedDrill.spaceRequired}</span>
									</div>
									<div className="text-sm">
										<div className="flex items-center gap-1 text-[#60758a] mb-1">
											<User className="w-4 h-4" />
											<span className="font-medium font-['Manrope',Helvetica]">Coach</span>
										</div>
										<span className="text-[#111418] font-['Manrope',Helvetica]">{selectedDrill.coach}</span>
									</div>
								</div>

								{/* Description */}
								<div>
									<h4 className="font-semibold text-[#111418] mb-2 font-['Manrope',Helvetica]">Description</h4>
								...
								{/* Drill Design */}
								<div>
									<h4 className="font-semibold text-[#111418] mb-2 font-['Manrope',Helvetica]">Drill Design</h4>
									<p className="text-[#60758a] text-sm leading-relaxed font-['Manrope',Helvetica]">
								...
								<div>
									...
									<div className="flex flex-wrap gap-2">
										{selectedDrill.equipment.map((item, index) => (
											<Badge key={index} variant="outline" className="text-xs font-['Manrope',Helvetica]">
												{item}
											</Badge>
										))}
									</div>
								...
								{/* Objectives */}
								<div>
									<h4 className="font-semibold text-[#111418] mb-2 font-['Manrope',Helvetica]">Objectives</h4>
									<ul className="space-y-1">
										{selectedDrill.objectives.map((objective, index) => (
											<li key={index} className="text-[#60758a] text-sm flex items-start gap-2 font-['Manrope',Helvetica]">
								...
								{/* Instructions */}
								<div>
									<h4 className="font-semibold text-[#111418] mb-2 font-['Manrope',Helvetica]">Instructions</h4>
									<ol className="space-y-2">
										{selectedDrill.instructions.map((instruction, index) => (
											<li key={index} className="text-[#60758a] text-sm flex gap-3 font-['Manrope',Helvetica]">
								...
								{selectedDrill.hasScoring && selectedDrill.scoringCriteria && (
									<div className="p-4 bg-red-50 rounded-lg">
										...
										<ul className="space-y-1">
											{selectedDrill.scoringCriteria.map((criteria, index) => (
												<li key={index} className="text-[#60758a] text-sm flex items-start gap-2 font-['Manrope',Helvetica]">
								...
								{selectedDrill.variations && selectedDrill.variations.length > 0 && (
									<div>
										<h4 className="font-semibold text-[#111418] mb-2 font-['Manrope',Helvetica]">Variations</h4>
										<ul className="space-y-1">
								...
								{/* Safety Notes */}
								{selectedDrill.safetyNotes && selectedDrill.safetyNotes.length > 0 && (
									<div className="p-4 bg-yellow-50 rounded-lg">
										<h4 className="font-semibold text-[#111418] mb-2 font-['Manrope',Helvetica] flex items-center gap-2">
											⚠️ Safety Notes
										</h4>
										<ul className="space-y-1">
											{selectedDrill.safetyNotes.map((note, index) => (
												<li key={index} className="text-[#60758a] text-sm flex items-start gap-2 font-['Manrope',Helvetica]">
