...
export const PlayerAssessment = (): JSX.Element => {
  ...
  const player = playerData[parseInt(playerId || "1") as keyof typeof playerData] || playerData[1];
    ...
    <div className="flex flex-col bg-white w-full min-h-screen">
      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f5] px-4 sm:px-10 py-3">
        <div className="flex items-center gap-4 text-[#111418]">
          ...
          <h2 className="text-[#111418] text-lg font-bold leading-tight tracking-[-0.015em] font-['Manrope',Helvetica]">
            Project Pro
          </h2>
        </div>
        <div className="flex flex-1 justify-end gap-8">
          <div className="hidden md:flex items-center gap-9">
            <Link
              to="/"
              className="text-[#111418] text-sm font-medium leading-normal font-['Manrope',Helvetica] hover:text-blue-600 transition-colors"
            >
              Dashboard
            </Link>
            <Link
            ...
            <div className="flex w-full flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-[#60758a] text-base font-normal leading-normal font-['Manrope',Helvetica]">
                    Age: {player.age} · Location: {player.location} · Strong Foot: {player.strongFoot}
                  </p>
                </div>
              </div>
            </div>
                    ...
                    >
                      ...
                      <TableCell className="px-4 py-2 text-[#60758a] text-sm font-normal leading-normal font-['Manrope',Helvetica]">
                        <span className={`font-semibold ${
                          ...
                          assessment.overallScore >= 80 ? 'text-blue-600' :
                          assessment.overallScore >= 70 ? 'text-orange-600' :
                          'text-red-600'
                        }`}>
